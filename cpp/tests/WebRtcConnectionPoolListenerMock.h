...
#ifndef WebRtcConnectionPoolListenerMock_h
#define WebRtcConnectionPoolListenerMock_h

#include "WebRtcConnectionPoolListener.h"

class WebRtcConnectionPoolListenerMock: public WebRtcConnectionPoolListener {
public:
...
#endif /* WebRtcConnectionPoolListenerMock_h */
